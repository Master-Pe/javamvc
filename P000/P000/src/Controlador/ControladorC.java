        ...
        return null;       
         ...
         public void EscribirPersona(ArrayList<Persona> listado)  {
             ...
             try {
                ...
                FileWriter nuevo =new FileWriter(archivo,true);
                String linea ;
         ...
         public void LeerPersona(ArrayList <Persona> listado){
        try {
            ...
            System.out.println("No encontrado el archivo");
                ...
                Logger.getLogger(ControladorC.class.getName()).log(Level.SEVERE, null, ex);
            }
